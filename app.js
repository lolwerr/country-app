...
result.innerHTML = `
    ...
    <p><b>Столица:</b> ${country.столица}</p>
    <p><b>Население:</b> ${country.население}</p>
    <p><b>Континент:</b> ${country.континент}</p>
    <p><b>Площадь:</b> ${country.площадь}</p>
    <p><b>Валюта:</b> ${country.валюта}</p>
    <p><b>Язык:</b> ${country.язык}</p>
    <p><b>Телефонный код:</b> ${country.кодТелефона}</p>
    <p><b>Домен:</b> ${country.домен}</p>
